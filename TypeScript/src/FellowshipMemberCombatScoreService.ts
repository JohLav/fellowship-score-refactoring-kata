    ...
    for (const memberId in data) {
      ...
      for (const key in memberRecords) {
        ...
        switch (true) {
          ...
          case (((record['race'] == 'homme' ||
            String(record['race']).toUpperCase() == 'HOBBIT' ||
            String(record['race']).toUpperCase() == 'NAIN') &&
            (record['battles_fought'] as number) <= 9 &&
          ...
          case (((record['race'] == 'elfe' ||
            ...
            ((record['race'] == 'elfe' ||
              ...
              (record['battles_fought'] as number) >= 5)) &&
            record['status'] == 'ring_bearer' &&
            (((record['corruption_resistance'] as number) <= 50 &&
              record['corruption_resistance'] !== null) ||
              record['power_source'] == 'light' ||
              record['power_source'] == 'mithril' ||
              record['power_source'] == 'lembas') &&
